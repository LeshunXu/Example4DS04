...
<!-- 1. An example of using instruments to reduce the variances (measurements error) -->

<!-- 2. checking if a new treatment is different to the old one -->

<!-- 3. A/B testing for two strategies -->
